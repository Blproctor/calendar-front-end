...
module.exports = {
  host: 'https://protected-hamlet-58469.herokuapp.com'
...
var eventEvents = __webpack_require__(13);
...
var signUp = function signUp(event) {
  ...
  userApi.signUp(data).then(userUi.signUpSuccess).catch(userUi.signUpError);
};

var signIn = function signIn(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  userApi.signIn(data).then(userUi.signInSuccess).catch(userUi.signInError);
};

var changePassword = function changePassword(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  userApi.changePassword(data).then(userUi.changePasswordSuccess).catch(userUi.changePasswordError);
};

var signOut = function signOut(event) {
  event.preventDefault();
  userApi.signOut().then(userUi.signOutSuccess).catch(userUi.signOutError);
};
module.exports = {
  signUp: signUp,
  signIn: signIn,
...
var eventApi = __webpack_require__(14);
var eventUi = __webpack_require__(15);
var getFormFields = __webpack_require__(3);
...
var createEvent = function createEvent(event) {
  ...
  console.log(data);
  eventApi.createEvent(data).then(eventUi.createEventSuccess).catch(eventUi.createEventError);
};

var getAllEvents = function getAllEvents(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  eventApi.getAllEvents(data).then(eventUi.getAllEventsSuccess).catch(eventUi.getAllEventsError);
};

var getEvent = function getEvent(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  eventApi.getEvent(data).then(eventUi.getEventSuccess).catch(eventUi.getEventError);
};

var updateEvent = function updateEvent(event) {
  event.preventDefault();
  var data = $('#thing-to-update').val();
  var id = this.getAttribute('data-id');
  eventApi.updateEvent(data, id).then(eventUi.updateEventSuccess).catch(eventUi.updateEventError);
};

var deleteEvent = function deleteEvent(event) {
  var id = this.getAttribute('data-id');
  event.preventDefault();
  eventApi.deleteEvent(id).then(eventUi.deleteEventSuccess).catch(eventUi.deleteEventError);
};
...
var getEvent = function getEvent(data) {
  console.log('passing through events api.js');
  return $.ajax({
...
var updateEvent = function updateEvent(data, id) {
  console.log('passing through events api.js');
  return $.ajax({
...
var createEventError = function createEventError(response) {
  console.error(response);
};
...
var updateEventError = function updateEventError() {
  console.log('nice try dude, no dice on that update, sorry');
};

var getAllEventsSuccess = function getAllEventsSuccess(data) {
...
var getAllEventsError = function getAllEventsError(response) {
  console.error(response);
};
...
var deleteEventError = function deleteEventError(error) {
  console.error(error);
  console.log('you never had your car');
};

var getEventSuccess = function getEventSuccess(data) {
  console.log(data);
};
